function getMyExtension(lib, game, ui, get, ai, _status) {
    ...
    extension_skills.mingkill_renxian_mark = {
        mark: 'character',
        intro: {
            content: '$任用您为他的心腹爱卿，并给予你技能【恢政】与【帝佑】直至他的下一个回合。',
        },
    ...
    extension_skills.mingkill_diyou = {
        charlotte: true,
    ...
    extension_skills.mingkill_renxian = {
    ...
    extension_skills.mingkill_wuchao = {
        zhuSkill: true,
    ...
    extension_skill_translate.mingkill_huizheng = "恢政";
    extension_skill_translate.mingkill_huizheng_info = "当你使用一张普通锦囊牌或延时锦囊牌结算后，你可以进行判定。若结果为：♥：你摸两张牌；♦：你回复 1 点体力。";
    extension_skill_translate.mingkill_renxian = "任贤";
    extension_skill_translate.mingkill_renxian_info = "结束阶段，你可以令一名其他玩家获得【恢政】与【帝佑】直至你的下一个回合。";
    extension_skill_translate.mingkill_diyou = "帝佑";
    extension_skill_translate.mingkill_diyou_info = "锁定技。当你的红色判定牌生效后，你令朱祐樘摸一张牌。";
    extension_skill_translate.mingkill_renxian_mark = "任贤";
    extension_skill_translate.mingkill_wuchao = "午朝";
    extension_skill_translate.mingkill_wuchao_info = "主公技。一名玩家的结束阶段，如果其于本回合内杀死过角色，则你可以令其执行一个额外的回合。";
    ...
    return {
        ...
        character_intro: extension_character_intro
    }
}
